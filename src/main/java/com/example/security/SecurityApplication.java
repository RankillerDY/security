    ...
    return args -> {
      var admin =
          RegisterRequest.builder()
              ...
              .password("846130225")
              .build();
      System.out.println("Admin authentication token " + auth.register(admin).getToken());
      ...
      var manager =
              RegisterRequest.builder()
                      ...
                      .password("1234")
                      .build();
      System.out.println("Manager authentication token " + auth.register(manager).getToken());
